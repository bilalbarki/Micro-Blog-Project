...
<div class="login_form">
    ...
    <form action="index.php" method="post">
      <div class="block"><div class="username_addon"><span class="user_icon"></span></div><input autofocus type="text" name="login" placeholder="Username" aria-label="username"></div>
      <div class="block"><div class="username_addon"><span class="password_icon"></span></div><input type="password" name="password" placeholder="Password" aria-label="password"></div>
