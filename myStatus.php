...
<body>
	...
	<div id="maincontainer">	<!--main container that contains every other body elements-->
		...
		<main>
            <article>
                <div class="asideGeneralBlock singleProfileName">	<!--User's own name-->
                	<h2>John Smith</h2>
                </div>
				<div class="asideGeneralBlock asideUsers">	<!--User's own picture, bio, etc. on the left side.-->				
			...
			<aside>
				<div class="blockFeed">	<!--Contains user's own statuses-->
					<?php
